...
# a long value is cut, and its full length reported
string(REPEAT "x" 100 long_value)
run(0 out set "${PE}" -t RT_RCDATA -n LONG --value "${long_value}")
expect_match("${out}" "\n    Value +'x+\\.\\.\\.' \\(100 characters\\)\n" "set long value row")
run(0 out remove "${PE}" -t RT_RCDATA -n LONG)
